              ...
              builder: (context, snap) {
                if (snap.hasData) {
                  ...
                  return Column(
                    ...
                    walletHistory.length==0 ? Center(child: Text("You do not have any wallet history yet",style: TextStyle(color: blackColor),),) :
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return FutureBuilder(
                              future: WalletServices()
                                  .getWalletHist(walletHistory[index]),
                                  ...
                                  return Column(
                                    children: [
                                      ReceiptCard(
                                          context: context,
                                          user: data,
                                            wallet: snapshot.data as EWallet?,
                                      ),
                                      Padding(
