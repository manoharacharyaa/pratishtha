                        ...
                        children: [
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              debugPrint("LEADERBORDS DOCS: ${documents}");
                              debugPrint("LEADERBORDS DOCS INDEX: ${index}");
                                ...
                                return Center(
                                  child: Container(
                                    padding: EdgeInsets.only(
                                      ...
                                      top: MediaQuery.of(context).size.width / 34,
                                    ),
                                    child: Center(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              leaderboardCard(
                                                  name: "${documents[index-1]['name']}",
                                                  score: "${documents[index-1]['score']}",
                                                  rank: 2,
                                                  context: context
                                              ),
                                              SizedBox(
                                              ...
                                              ListTile(
                                                title: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      "${documents[index]['name']}".toUpperCase(),
                                                      style: TextStyle(
                                                        color: blackColor,
                                                        fontSize: 16,
                                                    ...
                                                    LinearProgressIndicator(
                                                      ...
                                                      value: double.parse("${documents[index]['score']}")/double.parse("${documents[0]['score']}"),
                                                    ),
                                                    Text(
                                                      "Score : ${documents[index]['score']}",
                                                      style: TextStyle(
...
Widget leaderboardCard({required String name,required String score, String matchesWon = "",required int rank, required BuildContext context}){
  return Flexible(
    child: Container(
      //height: rank == 1 ? SizeConfig.blockSizeVertical*19 : SizeConfig.blockSizeVertical*15 ,
      height: (rank == 1) ? MediaQuery.of(context).size.height / 5 : MediaQuery.of(context).size.height / 7 ,
      width: rank==1? MediaQuery.of(context).size.height / 2 : MediaQuery.of(context).size.height / 4,
      decoration: BoxDecoration(
          borderRadius:
          BorderRadius.circular(kBorderRadius),
          color: rank == 1 ? goldColor :
          rank == 2 ? Colors.grey :
          // Colors.orange,
          Colors.brown
      ),
      child: Row(
        mainAxisAlignment: rank == 1 ? MainAxisAlignment.start : MainAxisAlignment.start,
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          Padding(
            padding:  EdgeInsets.only(
              left: rank == 1 ? MediaQuery.of(context).size.width/40 : MediaQuery.of(context).size.width/75,
            ...
            child: Row(
              ...
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                SizedBox(width: rank == 1 ? MediaQuery.of(context).size.width/30 : MediaQuery.of(context).size.width/70),
                CircleAvatar(
                  radius: (rank==1)?MediaQuery.of(context).size.width/13:MediaQuery.of(context).size.width/18,
                  backgroundColor: Colors.transparent,
                  backgroundImage: AssetImage(
                      (rank==1)?
                      'assets/gifs/trophy_burst_animation.gif':"assets/gifs/medallion_burst_animation.gif"
                ...
                SizedBox(width: rank == 1 ? MediaQuery.of(context).size.width/40 : MediaQuery.of(context).size.width/110),
                VerticalDivider(
                  //width: 17,
                  thickness: 5,
                  color: Colors.white,
                  ...
                  children: [
                    AutoSizeText("${name}".toUpperCase(),
                      ...
                      style: kPoppinsSemiBold.copyWith(
                        color: kWhite,
                        fontSize:
                        rank == 1 ? MediaQuery.of(context).size.height/35 : MediaQuery.of(context).size.height/65,
                      ),),
                    AutoSizeText("Score: $score",
                      ...
                      style: kPoppinsRegular.copyWith(
                        color: kWhite,
                        fontSize:
                        rank == 1 ? MediaQuery.of(context).size.height/45:MediaQuery.of(context).size.height/75,
                      ),),
                  ],
                )
              ],
