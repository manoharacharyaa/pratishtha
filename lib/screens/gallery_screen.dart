       ...
       body: SafeArea(
         child: Column(
           children: [
             ...
             SizedBox(height: 20,),
             Text('Pratishtha 2023 Album', style: TextStyle(fontWeight: FontWeight.bold),),
             ImageList(),
           ],
         ),
       ),
        ...
        Stack(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                IconButton(
                  icon: Icon(Icons.arrow_left, color: Colors.blue, size: 60),
                  onPressed: () {
                    if (currentIndex > 0) {
                ...
                IconButton(
                  icon: Icon(Icons.arrow_right, color: Colors.blue, size: 60),
                  onPressed: () {
